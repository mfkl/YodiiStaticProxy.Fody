...
//                    throw new CKException( R.HostApplyInvalidGeneralizationMismatchStopped );
                    throw new CKException("HostApplyInvalidGeneralizationMismatchStopped");
                }
            }
...
//                    throw new CKException( R.HostApplyInvalidGeneralizationMismatchStart );
                    throw new CKException("HostApplyInvalidGeneralizationMismatchStart");
                }
        ...
        [DebuggerDisplay(
            "Service={ServiceInfo}, Starting={Starting}, Implementation={Implementation}, SwappedImplementation={SwappedImplementation}, Generalization={ServiceGeneralization}"
            )]
        public class Impact
        {
            /// <summary>
